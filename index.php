        ...
        <section id="inicio" class="relative min-h-[780px] overflow-hidden text-cream sm:min-h-screen">
            ...
            <div class="relative mx-auto flex min-h-[780px] max-w-7xl items-center px-5 pb-16 pt-32 sm:min-h-screen lg:px-8">
                <div class="hero-copy max-w-[20rem] pt-10 reveal sm:max-w-[23rem] md:max-w-[26rem] lg:max-w-[36rem] xl:max-w-[42rem]">
                    ...
                    <h1 class="hero-title mt-7 font-serif text-[2.55rem] font-semibold leading-[1.02] sm:text-5xl lg:text-[4.25rem]">Nenhum trabalho deveria custar a sua saúde mental.</h1>
                    <p class="hero-copy-description mt-6 max-w-[20rem] text-base leading-8 text-cream/85 sm:max-w-[23rem] md:max-w-[26rem] lg:max-w-[34rem] xl:max-w-[39rem] lg:text-lg">Se você vive sob pressão excessiva, metas abusivas, assédio ou um ambiente que tem afetado sua saúde emocional, saiba que essa situação pode gerar direitos trabalhistas.</p>
