            ...
            <div class="relative mx-auto grid min-h-screen max-w-7xl items-center gap-10 px-5 py-20 lg:grid-cols-[.85fr_1.15fr] lg:px-8">
                <div class="reveal">
                    ...
                    <div class="mt-8 flex flex-col items-stretch gap-3 sm:flex-row">
                        <a href="index.php#inicio" class="soft-radius inline-flex items-center justify-center border border-sand px-7 py-4 text-xs font-bold uppercase tracking-[0.16em] text-sand transition hover:bg-sand hover:text-wineDark">Voltar ao início</a>
                        <a href="<?php echo e($whatsapp_link); ?>" target="_blank" rel="noopener" class="soft-radius inline-flex items-center justify-center gap-2 border border-cream/25 px-7 py-4 text-xs font-bold uppercase tracking-[0.16em] text-cream transition hover:border-cream">Falar com especialista</a>
                    </div>
                </div>
